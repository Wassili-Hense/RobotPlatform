...
#define BNO055_ACCEL_CONFIG_ADDR				      (0X108)
#define BNO055_MAG_CONFIG_ADDR					      (0X109)
#define BNO055_GYRO_CONFIG_ADDR					      (0X10A)
#define BNO055_GYRO_MODE_CONFIG_ADDR			    (0X10B)
#define BNO055_ACCEL_SLEEP_CONFIG_ADDR			  (0X10C)
#define BNO055_GYRO_SLEEP_CONFIG_ADDR			    (0X10D)
#define BNO055_MAG_SLEEP_CONFIG_ADDR			    (0x10E)
/* Interrupt registers*/
#define BNO055_INT_MASK_ADDR					        (0X10F)
#define BNO055_INT_ADDR							          (0X110)
#define BNO055_ACCEL_ANY_MOTION_THRES_ADDR		(0X111)
#define BNO055_ACCEL_INTR_SETTINGS_ADDR			  (0X112)
#define BNO055_ACCEL_HIGH_G_DURN_ADDR			    (0X113)
#define BNO055_ACCEL_HIGH_G_THRES_ADDR			  (0X114)
#define BNO055_ACCEL_NO_MOTION_THRES_ADDR		  (0X115)
#define BNO055_ACCEL_NO_MOTION_SET_ADDR			  (0X116)
#define BNO055_GYRO_INTR_SETING_ADDR			    (0X117)
#define BNO055_GYRO_HIGHRATE_X_SET_ADDR			  (0X118)
#define BNO055_GYRO_DURN_X_ADDR					      (0X119)
#define BNO055_GYRO_HIGHRATE_Y_SET_ADDR			  (0X11A)
#define BNO055_GYRO_DURN_Y_ADDR					      (0X11B)
#define BNO055_GYRO_HIGHRATE_Z_SET_ADDR			  (0X11C)
#define BNO055_GYRO_DURN_Z_ADDR					      (0X11D)
#define BNO055_GYRO_ANY_MOTION_THRES_ADDR		  (0X11E)
#define BNO055_GYRO_ANY_MOTION_SET_ADDR			  (0X11F)
